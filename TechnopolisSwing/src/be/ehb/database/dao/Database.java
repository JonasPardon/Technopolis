...
public class Database {
    private static String locatieMysqlServer = "jdbc:mysql://dt5.ehb.be:3306/IM2015GR013";
    private static String gebruikersnaam = "IM2015GR013";
    private static String wachtwoord = "42839561";
